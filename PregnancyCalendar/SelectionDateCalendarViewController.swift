//
//  SelectionDateCalendarViewController.swift
//  Календарь беременности
//
//  Created by deck on 24.08.16.
//  Copyright © 2016 farestz. All rights reserved.
//

import UIKit

var selectionBDstate = 0 // 0 - back 1 - ok

class SelectionDateCalendarViewController: UIViewController {

    var selectedBirthDate:DayView!
    ...
    func pressdone(){
        if selectedBirthDate != nil{
            selectionBDstate = 1
            BirthDate = selectedBirthDate.date.convertedDate()!
        }
    ...
    override func viewWillDisappear(animated: Bool) {
        self.performSegueWithIdentifier("dateupd", sender: self)
    }
}

extension SelectionDateCalendarViewController: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
...
extension SelectionDateCalendarViewController: CVCalendarViewAppearanceDelegate {
...
extension SelectionDateCalendarViewController {
