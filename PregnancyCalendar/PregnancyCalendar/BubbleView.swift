...
@IBDesignable public class BubbleView: UIView {
    ...
    override public func layoutSubviews() {
        let contentViewFrame = CGRect(x: cornerRadius, y: cornerRadius, width: frame.size.width - cornerRadius * 3.0, height: frame.size.height - cornerRadius * 3.0 - arrowHeight)
